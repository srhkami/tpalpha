...
export const list_kp = [
  new KeyPoint(
    ...
    <p>
      裝在手把兩端之照後鏡，算不算違規？從安規附件十五來看，照後鏡只要與車身主結構連接、不影響駕駛人視角即可。而安裝手把鏡後，只要車身寬度不超過
    ...
    <p >依據車輛型式安全審驗管理辦法附件27，照後鏡屬間接視野裝置，其目得在提供駕駛人後面、側邊之清晰視線，故有規定機車照後鏡「圓形鏡之直徑不得小於94公釐」、「非圓形鏡其尺寸需允許直徑78公釐的圓能鑲入反射面」。</p>
  ...
  new KeyPoint(
    ...
    `
      ...
      <h4 class="mt-4 mb-3">如非行駛，為停車狀態</h4>
  ...
  new KeyPoint(
    ...
    <p>①	車體部分，比照「未懸掛號牌之取締」程序辦理，另舉發<a href="#" class="showArticle" data-bs-toggle="modal" data-bs-target="#tipArea" data-rg="PH-12">舉罰條例12條</a>1項5款「使用他車牌照」。</p>
    ...
    <p>③	他車牌如為偽造車牌，舉發車體所有人12.1.3，違反刑法部分請參閱「偽/變造號牌之取締及偵辦」第二段。</p>
    <p>④	他車牌如為變造車牌：</p>
    <p>❶ 變造之車牌，如為他人所有，舉發車體所有人12.1.3。
    <br>→變造車牌還原後車號，如非失竊狀態，則舉發12.1.5「牌照借供他人使用」。
    <br>→變造車牌還原後車號，如為失竊狀態，依④之方式處理。
    <br>→變造車牌涉嫌刑法212條「變造特種文書罪」(變造行為已完成，非現行犯)、216條「行使變造文書罪」(使用中，現行犯)。</p>
